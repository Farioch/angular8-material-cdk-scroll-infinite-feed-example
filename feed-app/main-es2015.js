...
let DetectVisibilityDirective = class DetectVisibilityDirective {
    constructor(el) {
        this.el = el;
    ...
    detectVisibility(entries, observer) {
...
DetectVisibilityDirective.ctorParameters = () => [
...
let InfiniteFeedComponent = class InfiniteFeedComponent {
    constructor(dataService, cd) {
        ...
        this.trackByIndex = (index, item) => index;
    }
    ngOnInit() {
        this.loadTrigger$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["startWith"])(undefined), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["throttleTime"])(100), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(() => this.loadItems())).subscribe(items => {
            this.items = [...this.items, ...items];
            this.cd.detectChanges();
        });
    }
    ngAfterViewInit() {
        this.scrollViewport.elementScrolled().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(event => this.scrollViewport.getRenderedRange().end === this.scrollViewport.getDataLength())).subscribe(() => {
            this.currentPage++;
    ...
    loadMore() {
        ...
        this.items = [Object.assign({}, newItem, { visible: true }), ...this.items];
    }
    loadItems() {
        return this.dataService.getOldData(this.currentPage);
    }
};
InfiniteFeedComponent.ctorParameters = () => [
...
let InfiniteFeedModule = class InfiniteFeedModule {
};
